let dados = [
    {
        titulo : "Kartódromo Granja Viana",
        site : "https://kartodromogranjaviana.com.br/",
        descricao : "O Kartódromo Internacional Granja Viana, um dos mais renomados do Brasil, e é perfeito para você que busca se divertir com seus amigos! E não se preocupe se você nunca andou de Kart antes, o 'KGV', como é conhecido esse kartódromo, tem infraestrutura adequada para receber iniciantes e também conta com uma equipe de instrutores que farão com que você tenha uma experiencia incrivel na sua primeira corrida. O kartódromo está localizado na charmosa Granja Viana, em Cotia, São Paulo. Com uma área de 48.000 m², essa incrível estrutura oferece múltiplas opções de traçados, permitindo que pilotos de todos os níveis experimentem a emoção das corridas de kart. Seja você um piloto profissional ou um entusiasta amador, o Kartódromo Granja Viana garante diversão e adrenalina em cada volta!",
        valores : "R$ 155,00",
        positivo : "Kartódromo com excelente infraestrutura e karts bem equilibrados.",
        negativo : "Muito disputado. Difícil de conseguir um horário para correr. Normalmente é necessário agendar com semanas de antecedencia.",
        link : "https://youtu.be/9TdQ1epE5_U",
        tags: "Cotia são paulo sao paulo sp so famosa famoso raposo tavares bom"
    },
    {
        ...
        negativo : "Os karts não são muito bem equilibrados. Quebras de karts são recorrentes lá.",
        link : "https://youtu.be/nTFg08pWUcA",
        tags: "barato sp fernao dias rodovia interior facil"
    },
    {
        ...
        negativo : "A sua localização não é de tão facil acesso, pricipalemente para quem é da região mais central de São Paulo.",
        link : "https://youtu.be/uv1mS0NcJLY",
        tags: "interior sp são paulo anhanguera maior difícil dificil"
    },
    {
        ...
        negativo : "Não há muito entretenimento no kartódromo além da corrida.",
        link : "https://youtu.be/D6h-d4I2p9U",
        tags: "paulinia interior curva arvore potente"
    },
    {
        ...
        negativo : "Não tem muitas opções de traçados e nem sempre os karts são bem equilibrados, tendo disparidades ao longo das baterias.",
        link : "https://youtu.be/qAM6IKalNsc",
        tags: "ayrton senna sao paulo são famoso famosa autodromo autódromo"
    },
    {
        ...
        negativo : "Eventos abertos normalmente não são bem geridos. É comum superlotação de karts na pista criando-se literalmente uma corrida maluca.",
        link : "https://youtu.be/pO4xw9GCHPI",
        tags: "tatuape tatuapé radial leste salim maluf monaco sp sao paulo são"
    }
];
...
{
    titulo : "Kartódromo Internacional de Nova Odessa",
    descricao : "O Kartódromo Internacional de Nova Odessa é um verdadeiro paraíso para os amantes da velocidade. Localizado em Nova Odessa, interior de São Paulo, este kartódromo se destaca por ser a maior pista de kart do mundo, com mais de 2.700 metros de extensão.",
    link : "https://youtu.be/uv1mS0NcJLY"
}
*/